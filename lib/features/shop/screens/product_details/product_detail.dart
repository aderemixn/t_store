          ...
          children: [
            ...
            child: Column(
              children: [
                ...
                const ReadMoreText(
                  'This is a product description for Blue Nike Sleve less vest. There are more things that can be add but I decided not to do so. This product is directly from Nike store and the price is lower than the price from other vendors',
                  trimLines: 2,
