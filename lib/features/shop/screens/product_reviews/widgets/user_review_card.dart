  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: TSizes.spaceBtwItems),
        const ReadMoreText(
          'The user interface of the app is quite intuitive. I was able to navigate and make purchase seamlessly. Great job!. Please keep it up and you will surely have more customers all over the country',
          trimLines: 1,
