...
class TAppBarTheme {
  ...
  static const lightAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(color: TColors.black, fontSize: 18, fontWeight: FontWeight.w600),
  );
  ...
  static const darkAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(color: TColors.white, fontSize: 18, fontWeight: FontWeight.w600),
  );
}
